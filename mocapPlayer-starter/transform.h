...
//Rotate vector v around axis Z by angle c, around axis Y by angle b and around axis X by angle a
void vector_rotationZYX(double *v, double a, double b, double c);
